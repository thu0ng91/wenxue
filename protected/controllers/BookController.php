...
class BookController extends Q {
    ...
    public function actionIndex() {
        ...
        $sql = "SELECT b.id,b.colid,b.title,b.faceImg,b.`desc`,b.words,b.score,b.scorer,b.bookStatus,b.aid,b.shoufa,a.authorName FROM {{books}} b,{{authors}} a WHERE ".($colid>0 ? "b.colid='{$colid}' AND " : "")." b.status=" . Posts::STATUS_PASSED . " AND b.bookStatus IN(" . join(',',$arr) . ") AND b.aid=a.id AND a.status=".Posts::STATUS_PASSED." ORDER BY b.{$orderBy} DESC";
