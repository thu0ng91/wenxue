 ...
 ?>
  <?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'search-form',
        ...
        'action'=>Yii::app()->createUrl('/zmf/wenkuauthorinfo/index'),
...
<div class="input-group zmf-input-group">
         ...
         <?php echo CHtml::textField("author",$_GET["author"],array("class"=>"form-control","placeholder"=>$model->getAttributeLabel("author")));?>     
...
<?php $this->endWidget(); ?>
 ...
 <table class="table table-hover table-striped">
    <tr>    
                ...
                <th ><?php echo $model->getAttributeLabel("author");?></th>
