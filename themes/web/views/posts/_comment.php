...
<div class="media" id="comment-<?php echo $data['id']; ?>">
    ...
    <div class="media-left"><?php echo CHtml::link(CHtml::image(zmf::lazyImg(), $data['userInfo']['username'], array('data-original'=>$data['userInfo']['avatar'],'class'=>'lazy img-circle a48 media-object')),$data['userInfo']['linkArr']);?></div>
    <?php }?>
