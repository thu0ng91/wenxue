...
<div class="first-floor" id="reply-<?php echo $data['id'];?>">
        ...
        <div class="post-footer-nav">
            ...
            <div><?php echo CHtml::link('举报','javascript:;',array('action'=>'report','action-type'=>'post','action-id'=>$info['id'],'action-title'=>$info['title']));?></div>
            <div class="dropdown">
                <a class="dropdown-toggle" href="javascript:;" id="dropdownMenu3" data-toggle="dropdown" aria-expanded="true">
                    操作
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu3">
                    ...
                    <li role="presentation"><?php echo CHtml::link($info['top'] ? '已置顶' : '置顶','javascript:;',array('action'=>'setStatus','data-type'=>'post','data-action'=>'top','data-id'=>$info['id'],'role'=>'menuitem'));?></li>
                    <li role="presentation"><?php echo CHtml::link($info['styleStatus']==Posts::STATUS_BOLD ? '已加粗' : '加粗','javascript:;',array('action'=>'setStatus','data-type'=>'post','data-action'=>'bold','data-id'=>$info['id'],'role'=>'menuitem'));?></li>
                    <li role="presentation"><?php echo CHtml::link($info['styleStatus']==Posts::STATUS_RED ? '已标红' : '标红','javascript:;',array('action'=>'setStatus','data-type'=>'post','data-action'=>'red','data-id'=>$info['id'],'role'=>'menuitem'));?></li>
                    ...
                    <li role="presentation"><?php echo CHtml::link('删除','javascript:;',array('action'=>'delContent','data-type'=>'post','data-id'=>$info['id'],'data-confirm'=>1,'data-redirect'=>Yii::app()->createUrl('posts/index',array('type'=>$type)),'role'=>'menuitem'));?></li>
                    <?php }?>
