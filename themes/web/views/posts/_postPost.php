    ...
    <div class="media-body">
        ...
        <p>
            <span class="right-actions">
                ...
                <span><?php echo CHtml::link('打赏'.$data['comments'],'javascript:;',array('action'=>'getContents','data-id'=>$this->userInfo['id'],'data-type'=>'props','data-target'=>'props-holder-'.$data['id'],'data-loaded'=>0));?></span>
