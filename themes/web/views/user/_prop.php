...
<div class="prop-item">
    ...
    <?php if($type!='user'){echo $data['num']>0 ? CHtml::link('使用','javascript:;',array('action'=>'useProp','action-data'=>$passdata,'class'=>'btn btn-success btn-xs fixed-btn')) : CHtml::link('用罄','javascript:;',array('class'=>'btn btn-danger btn-xs fixed-btn disabled'));}?>
