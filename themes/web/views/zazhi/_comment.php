...
<div class="media" id="comment-<?php echo $data['id']; ?>">
    <div class="media-body">
        <p><b><?php echo CHtml::encode($_uname);?></b><?php if($data['tocommentid']>0 && !empty($data['toUserInfo'])){?> 回复 <b><?php echo $data['toUserInfo']['truename'];?></b><?php }?></p>
        ...
        <p class="help-block">
            ...
            <span class="pull-right">
                ...
                if($this->uid==$postInfo['uid'] || $this->userInfo['isAdmin'] || $this->uid==$data['uid']){
